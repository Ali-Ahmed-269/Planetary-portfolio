...
const SOCIAL_ITEMS: SocialItem[] = [
  { href: "https://github.com/Ali-Ahmed-269", icon: GithubIcon, label: "GitHub" },
  { href: "https://www.linkedin.com/in/ali-ahmed-489692328/", icon: LinkedinIcon, label: "LinkedIn" },
  { href: "https://www.instagram.com/ali_swati_26?stkn=MXEyM2wxdDBmbWxkcA==", icon: InstagramIcon, label: "Instagram" },
];
